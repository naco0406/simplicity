...
export const SIMPLICITY: Conference[] = [
    ...
    {
        id: '2',
        title: '토스 그래픽 더 토스답게 만들기',
        subtitle: '브랜드 아이덴티티를 강화하는 디자인 시스템',
        speaker: '김민지',
    ...
    {
        id: '3',
        title: '동의 화면도 간결하게 할 수 있을까',
        subtitle: 'UX 라이팅으로 복잡한 정보를 간단하게',
        speaker: '박민수',
    ...
    {
        id: '4',
        title: '토스가 디자인 툴을 만든 이유',
        subtitle: '개발자와 디자이너의 협업을 위한 도구',
        speaker: '조유성',
    ...
    {
        id: '5',
        title: 'AI 시대에 라이터로 살아남기',
        subtitle: '콘텐츠 제작의 미래와 인간의 역할',
        speaker: '오성식',
    ...
    {
        id: '6',
        title: '사용자 중심의 인터페이스 디자인',
        subtitle: '복잡한 금융 서비스를 간단하게',
        speaker: '이지은',
        role: 'UX Designer',
